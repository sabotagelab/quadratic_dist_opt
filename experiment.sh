...
# python mpc_test_fixed_pos_rand_obs.py --exp_dir /exp1_dist_no_fair --notion 2 --trials 200 --N 5 --dist &> /exp1_dist_no_fair/test.out
# python mpc_test_fixed_pos_rand_obs.py --exp_dir /exp1_dist_fair0 --notion 0 --trials 200 --N 5 --dist &> /exp1_dist_fair0/test.out
# python mpc_test_fixed_pos_rand_obs.py --exp_dir /exp1_dist_fair3 --notion 3 --trials 200 --N 5 --dist &> /exp1_dist_fair3/test.out
# python mpc_test_fixed_pos_rand_obs.py --exp_dir /exp1_dist_fair4 --notion 4 --trials 200 --N 5 --dist &> /exp1_dist_fair4/test.out
# python mpc_test_fixed_pos_rand_obs.py --exp_dir /exp1_dist_fair5 --notion 5 --trials 200 --N 5 --dist &> /exp1_dist_fair5/test.out
...
python mpc_test_fixed_obs_scale_num_drones.py --notion 2 --N 20 --trials 20 --dist &> exp2_dist_no_fair_N20_test.out
python mpc_test_fixed_obs_scale_num_drones.py --notion 4 --N 20 --trials 20 --dist &> exp2_dist_fair4_N20_test.out

python mpc_test_fixed_obs_scale_num_drones.py --notion 2 --N 50 --trials 5 --dist &> exp2_dist_no_fair_N20_test.out
python mpc_test_fixed_obs_scale_num_drones.py --notion 4 --N 50 --trials 5 --dist &> exp2_dist_no_fair_N20_test.out