...
echo 'NOTION 5'
python experiment_distributed.py --results_file fairness3 --N 3 --H 5 --eps_bounds 25 --notion 5 --alpha 0.0001
python experiment_distributed.py --results_file fairness3 --N 5 --H 5 --eps_bounds 25 --notion 5 --alpha 0.0001
python experiment_distributed.py --results_file fairness3 --N 7 --H 5 --eps_bounds 25 --notion 5 --alpha 0.0001
python experiment_distributed.py --results_file fairness3 --N 10 --H 5 --eps_bounds 25 --notion 5 --alpha 0.0001

python experiment_distributed.py --results_file fairness3 --N 15 --H 5 --eps_bounds 25 --Ubox 300 --notion 5 --alpha 0.0001
python experiment_distributed.py --results_file fairness3 --N 20 --H 5 --eps_bounds 25 --Ubox 300 --notion 5 --alpha 0.0001
...
echo 'NOTION 5'
python experiment_central.py --results_file fairness3 --N 3 --H 5 --eps_bounds 25 --notion 5 --alpha 0.0001
python experiment_central.py --results_file fairness3 --N 5 --H 5 --eps_bounds 25 --notion 5 --alpha 0.0001
python experiment_central.py --results_file fairness3 --N 7 --H 5 --eps_bounds 25 --notion 5 --alpha 0.0001
python experiment_central.py --results_file fairness3 --N 10 --H 5 --eps_bounds 25 --notion 5 --alpha 0.0001

python experiment_central.py --results_file fairness3 --N 15 --H 5 --eps_bounds 25 --Ubox 300 --notion 5 --alpha 0.0001
python experiment_central.py --results_file fairness3 --N 20 --H 5 --eps_bounds 25 --Ubox 300 --notion 5 --alpha 0.0001
